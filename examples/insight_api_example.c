...
int main(int argc, char *argv[]) {
    ...
    if (get_read_latency_percentiles(device, time_start, time_end,
    ...
    if (get_write_latency_percentiles(device, time_start, time_end,
                                      INSIGHT_JSON_QUERY_SESSION_ID_NONE, json_buffer) != 0) {
    ...
    if (get_write_amplification(device, time_start, time_end,
                                INSIGHT_JSON_QUERY_SESSION_ID_NONE, json_buffer) != 0) {
    ...
    if (get_qd_distribution(device, time_start, time_end,
                            INSIGHT_JSON_QUERY_SESSION_ID_NONE, json_buffer) != 0) {
    ...
    if (get_read_size_distribution(device, time_start, time_end,
                                   INSIGHT_JSON_QUERY_SESSION_ID_NONE, json_buffer) != 0) {
    ...
    if (get_write_size_distribution(device, time_start, time_end,
                                    INSIGHT_JSON_QUERY_SESSION_ID_NONE, json_buffer) != 0) {
    ...
    if (get_read_throughput_distribution(device, time_start, time_end,
                                         INSIGHT_JSON_QUERY_SESSION_ID_NONE, json_buffer) != 0) {
    ...
    if (get_write_throughput_distribution(device, time_start, time_end,
                                          INSIGHT_JSON_QUERY_SESSION_ID_NONE, json_buffer) != 0) {
    ...
    if (get_read_count_distribution(device, block_size, time_start, time_end,
                                    INSIGHT_JSON_QUERY_SESSION_ID_NONE, json_buffer) != 0) {
    ...
    if (get_lifecycle_distribution(device, block_size, time_start, time_end,
                                   INSIGHT_JSON_QUERY_SESSION_ID_NONE, json_buffer) != 0) {
    ...
    if (get_nand_write_volume(device, time_start, time_end,
                              INSIGHT_JSON_QUERY_SESSION_ID_NONE, json_buffer) != 0) {
    ...
    if (get_gc_data_movement(device, time_start, time_end,
                             INSIGHT_JSON_QUERY_SESSION_ID_NONE, json_buffer) != 0) {
